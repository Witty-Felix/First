...
//灯带的数组：
extern uint8_t rgb_send_cmd[];

//灯带实现的各种颜色
 extern uint8_t rgb_no_light[];
 extern uint8_t rgb_red_light[];
 extern uint8_t rgb_blue_light[];
 extern uint8_t rgb_green_light[];
 extern uint8_t rgb_yellow_light[];
 extern uint8_t rgb_color_light[];
